...
module.exports = {
  config: { name: "tr", aliases: ["translate"], permission: 0, prefix: false, cooldowns: 3, categorie: "Tools", description: "Translate text. Usage: tr <lang> <text>", credit: "MOMINUR ISLAM" },
