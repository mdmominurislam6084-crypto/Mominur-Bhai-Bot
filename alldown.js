...
module.exports = {
  config: { name: "alldown", aliases: ["vd","dl","download"], permission: 0, prefix: false, categorie: "Downloader", description: "Auto download video from any link.", credit: "MOMINUR ISLAM" },
