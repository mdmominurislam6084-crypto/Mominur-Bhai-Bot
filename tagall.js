module.exports = {
  config: { name: "tagall", aliases: ["all","everyone"], permission: 3, prefix: false, botAdmin: false, categorie: "Group", description: "Tag all group members.", credit: "MOMINUR ISLAM" },
